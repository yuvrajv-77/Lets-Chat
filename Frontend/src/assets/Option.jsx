...
function Option() {
  return (
    <div className='p-3 rounded-full hover:bg-gray-200 cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
